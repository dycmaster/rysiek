...
public class ScriptRunner {
	...
	Logger logger = Logger.getLogger(ScriptRunner.class);

	/*
	 To parse settings from deployed scripts
	 */
	...
	public ScriptRunner(File f) {
		...
		setEnabled(readIsSensorEnabled(f));
	...
	protected boolean readIsSensorEnabled(File scriptToDeploy) {
